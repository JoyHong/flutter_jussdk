...
class JusApplyUserRelation {
  ...
  @override
  String toString() {
    return 'JusApplyUserRelation{uid: $uid, nickName: $nickName, msgIdx: $msgIdx, type: $type, desc: $desc, extraParamMap: $extraParamMap, timestamp: $timestamp}';
  }
}
