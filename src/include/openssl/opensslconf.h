...
/******************* for HarmonyOS ********************/
#elif defined(OPENSSL_CONF_FILE_OHOS_X86_64)
#include <openssl/conf_ohos_x86_64.h>

#elif defined(OPENSSL_CONF_FILE_OHOS_ARM64)
#include <openssl/conf_ohos_arm64.h>
