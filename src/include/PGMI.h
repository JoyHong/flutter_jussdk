...
{
public:
    WriteRelRqst(const String& cookie, const String& groupId);
...
class SendP2PMsgRqst : public Rqst
{
public:
...
private:
    ...
    Status::StatusTimes _X3DHMsgStatuses, _sentMsgStatusesDiff;
    int _step;
};
...
public:
    ...
    // TODO pengl, 后续需要针对组织消息扩展
    deque<SendP2PMsgRqstPtr> _pendingSendMsgRqsts;
